  ...
  },
  {
    ...
    config: {
      ...
      receiverPatterns: {
        ...
        senderStore: "(?:发件门店|发货门店|发件机构|发货仓库)[:：]\\s*(?<value>[^\\n]+)",
        senderName: "(?:发件人|发货人|寄件人)[:：]\\s*(?<value>[^\\n]+)",
        senderPhone: "(?:发件电话|发货电话|寄件人电话)[:：]\\s*(?<value>1\\d{10})",
        senderAddress: "(?:发件地址|发货地址|寄件地址)[:：]\\s*(?<value>[^\\n]+)",
        receiverStore: "收货机构[:：]\\s*(?<value>[^\\n\\t]+)",
        receiverName: "收货人[:：]\\s*(?<value>[^\\n]+)",
        receiverPhone: "收货电话[:：]\\s*(?<value>1\\d{10})",
        receiverAddress: "收货地址[:：]\\s*(?<value>[^\\n]+)",
        amount: "(?:运单金额|金额|货款金额|合计金额)[:：]\\s*(?<value>\\d+(?:\\.\\d{1,2})?)",
        waybillStatus: "(?:运单状态|状态|配送状态|物流状态)[:：]\\s*(?<value>[^\\n]+)",
        sourceUpdatedAt: "(?:来源更新时间|更新时间|同步时间)[:：]\\s*(?<value>[^\\n]+)",
      },
    },
    createdAt: "2026-06-05T00:00:00.000Z",
    updatedAt: "2026-06-05T00:00:00.000Z",
